          ...
          <div className="nav-content">
            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
              ...
              <ul className="mb-1 top-content">
                ...
                <li>
                  <Link to="default.html" className="nav-content-bttn open-font">
                    <i className="feather-tv btn-round-md bg-blue-gradiant me-3"></i>
                    <span>Newsfeed</span>
                  </Link>
                </li>
                <li>
                  <Link to="default-badge.html"
            ...
            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2">
              ...
              <ul className="mb-3">
                <li>
                  <Link to="default-email-box.html"
                    className="nav-content-bttn open-font"
                  >
                ...
                <li>
                  <Link to="default-live-stream.html"
                    className="nav-content-bttn open-font"
                  >
            ...
            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1">
              ...
              <ul className="mb-1">
                ...
                <li>
                  <Link to="default-analytics.html"
                    className="nav-content-bttn open-font h-auto pt-2 pb-2"
                  >
