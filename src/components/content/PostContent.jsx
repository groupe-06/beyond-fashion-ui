                                ...
                                <div class="owl-carousel category-card owl-theme overflow-hidden nav-none">
                                    <div class="item">
                                        <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                            <div class="card-body position-relative h100 bg-image-cover bg-image-center" style={{backgroundImage: `url('./public/images/u-bg.jpg')`}}></div>
                                    ...
                                    <div class="item">
                                        <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                            <div class="card-body position-relative h100 bg-image-cover bg-image-center" style={{backgroundImage: `url('./public/images/s-2.jpg')`}}></div>
                                            <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                    ...
                                    <div class="item">
                                        <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                            <div class="card-body position-relative h100 bg-image-cover bg-image-center" style={{backgroundImage: `url('./public/images/s-6.jpg')`}}></div>
                                            <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                    ...
                                    <div class="item">
                                        <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                            <div class="card-body position-relative h100 bg-image-cover bg-image-center" style={{backgroundImage: `url('./public/images/bb-16.png')`}}></div>
                                            <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                    ...
                                    <div class="item">
                                        <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                            <div class="card-body position-relative h100 bg-image-cover bg-image-center" style={{backgroundImage: `url('./public/images/e-4.jpg')`}}></div>
                                            <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                    ...
                                    <div class="item">
                                        <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                            <div class="card-body position-relative h100 bg-image-cover bg-image-center" style={{backgroundImage: `url('./public/images/coming-soon.png')`}}></div>
                                            <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                    ...
                                    <div class="item">
                                        <div class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                            <div class="card-body position-relative h100 bg-image-cover bg-image-center" style={{backgroundImage: `url('./public/images/bb-9.jpg')`}}></div>
                                            <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
